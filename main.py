...
print("\nI observed that, compared to the Starter code, the test accuracy increased from 22.3% to 74.6% in the Final code, representing an improvement of 52.3 percentage points. Additionally, the training accuracy had a significant rise from 18.5% to 96.9%, indicating an improvement of 78.4 percentage points. Furthermore, the confusion matrix reveals that in the Starter code, many classes had zero true positives, whereas in the Final code, the results are more balanced, with all the classes having more true positives.") 


# this code will form and print the confusion matrix of this project
...
print("\n The model most often misidentifies class 0 (letter A), class 1 (letter B), and class 3 (letter D).")